...
> This is a modified version of [Unique3D](https://github.com/AiuniAI/Unique3D).


We have modified the Unique3D code to leverage its normal diffusion model for predicting normal maps from input RGB portrait images.
