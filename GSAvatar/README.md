...
> This project is a modified version of [GaussianAvatars](https://github.com/ShenhanQian/GaussianAvatars).  


 
**Key modifications compared to the original GaussianAvatars:**  
1. Integrated a **diffusion model** and a **ControlNet** for enhanced guidance.  
2. Replaced **FLAME** with **SMPL-X** for animation.
