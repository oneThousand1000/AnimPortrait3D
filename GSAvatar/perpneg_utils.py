...
def get_pos_neg_text_embeddings(embeddings, azimuth_val,front_decay_factor,side_decay_factor,negative_w ):
    '''
...
def adjust_text_embeddings(embeddings, azimuth,front_decay_factor,side_decay_factor,negative_w ):
    text_z_list = []
    weights_list = []
    K = 0
    for b in range(azimuth.shape[0]):
        text_z_, weights_ = get_pos_neg_text_embeddings(embeddings, azimuth[b],front_decay_factor,side_decay_factor,negative_w )
