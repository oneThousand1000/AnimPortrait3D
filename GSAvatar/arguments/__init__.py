...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self._points_cloud_path = ""  # Path to the points cloud
        self._images = "images"
        self._resolution = -1
        ...
        self.not_finetune_smplx_params = False
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.feature_lr = 0.0025*1.5
        self.opacity_lr = 0.05*1.5
        # (scaled up according to mean triangle scale)  # 0.005 (original)
        self.scaling_lr = 0.017*1.5
        self.rotation_lr = 0.001*1.5
        self.densification_interval = 1000  # 100 (original)
        self.opacity_reset_interval = 3000  # 3000 (original)
        self.densify_from_iter = 1000  # 500 (original)
